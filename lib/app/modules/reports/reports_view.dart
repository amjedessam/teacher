...
//             _buildReportCard(
//               title: '  الخلاصه اليوميه - نشاط / واجب ',
//               description: 'نشاط حصه اليوم ',
//               icon: Icons.people_outline,
//               color: AppColors.error,
//               onTap: controller.openStrugglingStudents,
//             ),
//             _buildReportCard(
//               title: 'ملاحظه لطالب معين',
//               description: 'ماذا درسنا اليوم',
//               icon: Icons.subject,
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // ملاحظة لطالب معين
            // _buildReportCard(
            //   title: 'ملاحظة لطالب معين',
            //   description: 'افتح من تفاصيل الطالب مباشرة',
            //   icon: Icons.person_pin_outlined,
            //   color: AppColors.secondary,
            //   isDisabled: true,
            //   onTap: controller.openStudentNote,
            // ),
            _buildReportCard(
              title: 'الفجوات المنهجية',
              description: 'المواضيع التي تحتاج تركيز أكثر',
