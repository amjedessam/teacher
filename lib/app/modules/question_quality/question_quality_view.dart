...
//                     (context, index) =>
//                         _buildQuestionCard(controller.filteredQuestions[index]),
...
//                 _buildStatChip(
//                   'الإجمالي',
//                   controller.totalQuestions.toString(),
//                   Colors.white,
//                 ),
...
//                 _buildStatChip(
//                   'مقبول',
//                   controller.fairCount.toString(),
//                   const Color(0xFFFF9800),
//                 ),
//                 const SizedBox(width: 8),
//                 _buildStatChip(
//                   'يحتاج مراجعة',
//                   controller.needsReviewCount.toString(),
//                   const Color(0xFFF44336),
//                 ),
//                 const SizedBox(width: 8),
//                 _buildStatChip(
//                   'لم يُستخدم',
//                   controller.unusedCount.toString(),
...
//                     (s) => _buildFilterChip(
//                       label: s['name']!,
//                       isSelected: controller.selectedSubjectId.value == s['id'],
...
//                   _buildFilterChip(
//                     label: 'كل الجودة',
//                     isSelected: controller.selectedQuality.value == null,
//                     onTap: () => controller.filterByQuality(null),
//                     color: AppColors.primary,
//                   ),
//                   ...[
//                     'ممتاز',
...
//                     (q) => _buildFilterChip(
//                       label: q,
//                       isSelected: controller.selectedQuality.value == q,
//                       onTap: () => controller.filterByQuality(q),
//                       color: controller.getQualityColor(q),
//                     ),
//                   ),
//                 ],
//               ),
...
//     final qualityColor = controller.getQualityColor(question.quality);
//     final total = question.timesCorrect + question.timesIncorrect;
//     final successRate = total > 0
//         ? (question.timesCorrect / total * 100).toStringAsFixed(0)
//         : null;
...
//         border: Border(right: BorderSide(color: qualityColor, width: 4)),
//         boxShadow: [
//           BoxShadow(
...
//           crossAxisAlignment: CrossAxisAlignment.start,
//           children: [
//             // ── الصف العلوي: نص السؤال + badge الجودة ────
//             Row(
//               crossAxisAlignment: CrossAxisAlignment.start,
//               children: [
//                 Expanded(
...
//                   ),
//                   child: Text(
//                     controller.getDifficultyLabel(question.difficulty),
//                     style: TextStyle(
//                       fontSize: 11,
//                       fontWeight: FontWeight.w600,
//                       color: controller.getDifficultyColor(question.difficulty),
//                     ),
//                   ),
//                 ),
//               ],
